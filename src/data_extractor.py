...
class DataExtractor:
    ...
    def report(self) -> None:
        ...
        # Report nulls across all columns
    ...
    def _synthetic_raw_data(n: int = 300) -> pd.DataFrame:
        ...
        for i in range(1, n + 1):
            ...
            # Billing info — intentional edge cases
            ...
            # Introduce occasional nulls and overpayments for ETL practice
            ...
            bill_date   = appt_date  # typically same day
